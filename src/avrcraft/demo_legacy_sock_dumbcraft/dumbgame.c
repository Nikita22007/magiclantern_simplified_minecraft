...
#include "../dumbcraft/dumbutils.h"
#include <string.h>
#include <stdlib.h>

static uint8_t regaddr_set;
static uint8_t regval_set;

static volatile uint8_t regaddr_get;
static volatile uint8_t regval_get;

static uint8_t hasset_value;
static uint8_t latch_setting_value;

static uint8_t didflip = 1;
static uint8_t flipx, flipy, flipz;
...
void GameTick()
{
	...
	if( didflip )
	{
		EntityUpdatePos( 3, 1%512, 64*32, 1%512, 0, 0 );
